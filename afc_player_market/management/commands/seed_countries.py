...
from afc_player_market.models import Country
...
COUNTRIES = [
    ...
    ("CG", "Congo"), ("CD", "DR Congo"), ("CR", "Costa Rica"), ("CI", "Côte d’Ivoire"),
...
class Command(BaseCommand):
    help = "Seed all countries"

    def handle(self, *args, **kwargs):
        created = 0

        for code, name in COUNTRIES:
            obj, is_created = Country.objects.get_or_create(code=code, defaults={"name": name})
            if is_created:
                created += 1
