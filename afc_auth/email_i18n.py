...
COPY = {
    ...
    "partner_apply_approved": {
        "en": {
            ...
            "sso_grants": "What AFC will release about a player who signs in through you, and nothing more: {grants}. If you later need something else, ask us; every grant is switched on by AFC, never requested from the player.",
        ...
        "fr": {
            ...
            "sso_grants": "Ce que l'AFC communiquera sur un joueur qui se connecte via vous, et rien de plus : {grants}. Si vous avez besoin d'autre chose par la suite, demandez-nous ; chaque autorisation est activée par l'AFC, jamais demandée au joueur.",
        ...
        "pt": {
            ...
            "sso_grants": "O que a AFC disponibiliza sobre um jogador que inicia sessão através de si, e nada mais: {grants}. Se mais tarde precisar de outra coisa, peça-nos; cada permissão é ativada pela AFC, nunca pedida ao jogador.",
